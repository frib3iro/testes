...
########################################## Uso ##############################################
# Copie as funções abaixo (funções de atraso e progresso) diretamente para o seu shell script
# Em seguida, chame a função progress para mostrar a barra de progresso
# Por outro lado, você pode importar a fonte indiretamente e depois usá-la. Nada diferente
#############################################################################################
